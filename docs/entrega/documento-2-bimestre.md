...
| 19/08/26 | 0.7 | Protótipo das telas — 1ª entrega | Sergio, Arthur, Leonardo e Thales 🟦 |
| 19/08/26 | 0.8.1 | Diagramas de Comunicação | Sergio, Arthur, Leonardo e Thales 🟦 |
| 19/08/26 | 0.8.2 | Mapeamento para o Diagrama Entidade-Relacionamento | Sergio, Arthur, Leonardo e Thales 🟦 |
| 19/08/26 | 0.8.3 | Diagramas de Estados | Sergio, Arthur, Leonardo e Thales 🟦 |
| 19/08/26 | 0.8.4 | Diagramas de Atividades | Sergio, Arthur, Leonardo e Thales 🟦 |
| 19/08/26 | 0.9 | Implementação do sistema e testes | Sergio, Arthur, Leonardo e Thales 🟦 |
...
Figura 5. Painel de análise, com gráfico de velas, médias móveis e indicadores do período.  
Figura 6. Tela de detalhes do ativo, com fundamentos, histórico e reavaliação regra a regra.  
Figura 7. Tela de recomendações vigentes com justificativa.  
Figura 8. Tela da carteira com resultado consolidado.  
Figura 9. Tela de alertas de preço.  
Figura 10. Tela de administração de ativos.  
Figura 11. Tela de importação de cotações com relatório de validação.  
Figura 12. Tela de configuração das regras de análise.  
Figura 13. Tela de gerenciamento de usuários.  
...
![Figura 1. Sessão online de Planning Poker. 🟦](figuras/planning-poker.png)
...
![Figura 2. Tela de login.](figuras/tela-01-login.png)

![Figura 3. Janela principal com a navegação do papel Administrador.](figuras/tela-11-janela-principal-admin.png)

![Figura 4. Janela principal com a navegação do papel Investidor.](figuras/tela-12-janela-principal-investidor.png)

![Figura 5. Painel de análise, com gráfico de velas, médias móveis e indicadores do período.](figuras/tela-02-painel-analise.png)

![Figura 6. Tela de detalhes do ativo, com fundamentos, histórico e reavaliação regra a regra.](figuras/tela-03-detalhe-ativo.png)

![Figura 7. Tela de recomendações vigentes com justificativa.](figuras/tela-04-recomendacoes.png)

![Figura 8. Tela da carteira com resultado consolidado.](figuras/tela-05-carteira.png)

![Figura 9. Tela de alertas de preço.](figuras/tela-06-alertas.png)

![Figura 10. Tela de administração de ativos.](figuras/tela-07-ativos.png)

![Figura 11. Tela de importação de cotações com relatório de validação.](figuras/tela-08-importacao.png)

![Figura 12. Tela de configuração das regras de análise.](figuras/tela-09-regras.png)

![Figura 13. Tela de gerenciamento de usuários.](figuras/tela-10-usuarios.png)
...
![Figura 14. Diagrama de casos de uso.](figuras/uc-casos-de-uso.png)
...
![Figura 15. Diagrama de classes do domínio do sistema.](figuras/cls-dominio.png)
...
![Figura 16. Diagrama de classes do núcleo de análise, com o padrão Strategy.](figuras/cls-analise.png)
...
![Figura 17. Diagrama de classes da arquitetura em camadas.](figuras/cls-arquitetura.png)
...
![Figura 18. Diagrama de objetos da análise de um ativo.](figuras/obj-analise.png)

![Figura 19. Diagrama de objetos da carteira do investidor.](figuras/obj-carteira.png)
...
Sequência sob a ótica da estrutura: os objetos participantes aparecem como uma rede
